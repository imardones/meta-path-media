...
const context = require.context('../images/projects/', true);
const images = {};
...
function Projects() {
    return (
        <Halo id={'projects'} rings={4} childElem={
				...
				<div className='section-head'>
					...
					<div className='filters'>
						...
						<select>
							...
							<option value='f-s_dev' >full-stack development</option>
							<option value='f-e_dev' >front-end development</option>
							<option value='special'>special-project</option>
							<option value='ux_ui'>ux-ui design</option>
							<option value='intra'>intranet site</option>
